 ...
 server {
	...
	root /var/www/beta.jobsnotguns.com/html;

	server_name beta.jobsnotguns.com www.beta.jobsnotguns.com;
 ...
 server {
   ...
   if ($host = www.beta.jobsnotguns.com) {
        return 301 https://$host$request_uri;
    }

    if ($host = beta.jobsnotguns.com) {
        return 301 https://$host$request_uri;
    }
