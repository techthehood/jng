 ...
 server {
    ...
    ssl_certificate /etc/letsencrypt/live/jobsnotguns.com/fullchain.pem; # managed by Certbot
    ssl_certificate_key /etc/letsencrypt/live/jobsnotguns.com/privkey.pem; # managed by Certbot
 ...
 server {
    ...
    server_name jobsnotguns.work jobsnotguns.careers www.jobsnotguns.work www.jobsnotguns.careers; # managed by Certbot
    return 404;
 ...
 server {
    if ($host = www.jobsnotguns.careers) {
        return 301 https://$host$request_uri;
    } # managed by Certbot


    if ($host = jobsnotguns.careers) {
        return 301 https://$host$request_uri;
    } # managed by Certbot


    if ($host = www.jobsnotguns.work) {
        return 301 https://$host$request_uri;
    } # managed by Certbot


    if ($host = jobsnotguns.work) {
        return 301 https://$host$request_uri;
    } # managed by Certbot
    ...
    listen 80 ;
    listen [::]:80 ;
    server_name jobsnotguns.work jobsnotguns.careers www.jobsnotguns.work www.jobsnotguns.careers;
