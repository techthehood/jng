...
import MegaOne from './components/MegaOne';
import Exporter from './components/MegaOne/components/DigitalAgency/Exporter';
...
// require('./main.scss');
import './main.scss';
import CustomHtml from './components/MegaOne/components/DigitalAgency/Events/templates/CustomHtml.jsx';
import use_root from '../tools/use_root.jsx';
...
const App = () => {
  ...
  useEffect(() => {
    ...
    // const render = customContent({});
    const render = <CustomHtml />;
    set_event_custom(render);
  ...
  const [event_custom , set_event_custom] = useState("");
