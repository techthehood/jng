...
import WWAHtml from './templates/WWAHtml';
...
const WWA = (props) => {
  ...
  */
  ...
  let services_wrapper = (
    <Exporter {...{ home: `.service-details-inner${tag_cls}`, delay: 2 }}>
      {services_details}
    </Exporter>
  );

  let content_wrapper = use_data.length > 1 ? (
    <Exporter {...{ home: `.services-area${tag_cls}`, delay: 2, initialize }}>
  ...
  const h_cont = <WWAHtml {...data} />;// htmlContent(data);
